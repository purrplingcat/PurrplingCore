...
namespace PurrplingCore.Movement
{
    /// <summary>
    /// A joystic for follow a path to a target tile. The core of NPC following.
    /// </summary>
    internal class NpcMovementController : Internal.IUpdateable
    {
        ...
        public NpcMovementController(NPC follower, PathFinder pathFinder)
        {
